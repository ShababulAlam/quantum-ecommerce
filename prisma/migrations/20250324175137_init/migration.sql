...
CREATE TABLE `ProductToCategory` (
    ...
    INDEX `ProductToCategory_productId_idx`(`productId`),
    INDEX `ProductToCategory_categoryId_idx`(`categoryId`),
    UNIQUE INDEX `ProductToCategory_productId_categoryId_key`(`productId`, `categoryId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `SeoSettings` (
    ...
    UNIQUE INDEX `SeoSettings_page_key`(`page`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
